						...
						<div class="box">
							...
							<div class="box-content">
								<div class="btn-toolbar pull-right clearfix">
									<div class="btn-group">
										<a class="btn btn-circle" title="Exportar Pedidos com Produtos" href="<?php echo $url_site_admin ?>xls_pedidos.php"><i class="icon-table"></i></a>
										<a class="btn btn-circle" title="Exportar Pedidos" href="<?php echo $url_site_admin ?>xls_pedidos2.php"><i class="icon-shopping-cart"></i></a>
									</div>
								</div>
								<div class="clearfix"></div>
								<table class="table table-advance" id="table2" data-table="pedido">
									<thead>
										<tr>
											<th>Pedido #</th>
											<th>Pedido MP #</th>
									...
									<tbody>
										<?php 
											$lista = CRUD::Select('pedido','id DESC');
